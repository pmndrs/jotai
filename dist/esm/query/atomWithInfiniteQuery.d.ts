import type { InfiniteData, InfiniteQueryObserverOptions, QueryKey, RefetchOptions, RefetchQueryFilters } from 'react-query';
...
export declare type AtomWithInfiniteQueryOptionsWithEnabled<TQueryFnData, TError, TData, TQueryData> = Omit<AtomWithInfiniteQueryOptions<TQueryFnData, TError, TData, TQueryData>, 'enabled'> & {
    enabled: boolean;
};
