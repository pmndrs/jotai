...
### `onMount` property (deprecated)

⚠️ **Deprecated**: The `onMount` property is deprecated. Use the [`withMount` mixin](../utilities/mixins.mdx#withmount) from `jotai/utils` instead.
