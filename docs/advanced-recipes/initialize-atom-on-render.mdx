...
These atoms' initial state is determined by the props passed to the component.

Below is a basic example of illustrating how you can use `Provider` and its prop, `initialValues`, to achieve initialize state.
