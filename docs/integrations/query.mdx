...
If you want to use your own `queryClient` set by your [options](https://tanstack.com/query/v4/docs/reference/QueryClient) instead of default options, you can also do it as below.
