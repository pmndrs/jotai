...
The first `getArgs` parameter is a function that returns an array of arguments to those functions.
The second optional `getClient` parameter is a function that returns [Client](https://formidable.com/open-source/urql/docs/api/core/#client).
