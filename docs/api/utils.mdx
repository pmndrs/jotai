...
[`useResetAtom`](/docs/api/utils/#use-reset-atom) hook. It works exactly the same
way as primitive atom would, but you are also able to set it to a special value
[`RESET`](/docs/api/utils/#reset). See examples in [Resettable atoms](/docs/guides/resettable).
...
Resets a [Resettable atom](/docs/guides/resettable/) to its initial value.
...
Special value that is accepted by [Resettable atoms](/docs/guides/resettable/)
created with [`atomWithReset`](/docs/api/utils/#atom-with-reset), [`atomWithDefault`](/docs/api/utils/#atom-with-default)
...
There's more examples in the [Next.js section](/docs/guides/nextjs/).
