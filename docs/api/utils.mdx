...
20. [loadable](../utils/loadable.mdx)
    ...
    The `loadable` API will allow you to bypass the inherent the suspending happening at the core of asynchronous flows in jotai. Wrap your atoms with `loadable` and you directly get the results of your async atoms as an object with a state to tell you if the Promise has resolved or even failed.
