...
5. [useSetAtom](../utils/use-set-atom.mdx)

   Returns the setter function of the given atom.

6. [atomWithReset](../utils/atom-with-reset.mdx)

   Creates an atom that could be reset to its `initialValue` with `useResetAtom` hook.

7. [useResetAtom](../utils/use-reset-atom.mdx)

   Resets a Resettable atom to its initial value.

8. [RESET](../utils/reset.mdx)
...
17. [freezeAtomCreator](../utils/freeze-atom-creator.mdx)
