...
You can directly use the [atomWithStorage function in the utils bundle](../api/utils.mdx#atom-with-storage), specifying your favorite AsyncStorage library. The atom has to be loaded before being used in async actions.
