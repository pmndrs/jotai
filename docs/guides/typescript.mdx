...
Jotai relies heavily on type inferences and requires `strictNullChecks` to be enabled. Consider adding `"strict": true` in your tsconfig.json. [Reference](https://github.com/pmndrs/jotai/issues/838)
