...
An atom in jotai represents a piece of state. It can be any data ranging from string, boolean or number to complex structures like arrays, objects, functions and so on.
